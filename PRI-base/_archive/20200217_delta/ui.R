...
drfz.logo = "https://cdn.pressebox.de/r/c337d050fa456cf4/attachments/25/52/18/thumbnail_255218_400x320.jpg"
drfz.logo = "https://cdn.pressebox.de/f/11de5cf5d4ea5903/logos/100443/500_500.gif"
drfz.logo = file.path(getwd(),"App20170929/www/Images/DRFZlogo.jpg")
anchor <- tags$a(target="_blank", href="http://www.drfz.de/en/",
                 tags$img(src=drfz.logo, height = "90", hspace="20"),
                 "PRIbase")
