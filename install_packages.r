...
install.packages(packageurl, dependencies=TRUE, repos=NULL, type="source", lib = Lib.path)
...
install.packages(c("shinydashboard", "shinyjs", "V8", "shinyBS", "rJava", "xml2", "RISmed", "rChoiceDialogs", "digest", "gtools", "stringr", "httr", "roxygen2", "DT", "xlsx"), lib = Lib.path)
