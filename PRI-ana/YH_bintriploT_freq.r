...
############################################################
############## 20180426 PRI manuscript Fig 7 E
...
############# 20180605 FOR PRI-Manuscript Fig5e
#X: TNFa
#Y: IFNg
#Z: IL2 + IL21.
...
############# 20180621 for PRI-Manuscript Fig5e
#X: TNFa
#Y: IFNg
#Z: IL2 + IL21.
#Hi Yen,
# würdest Du für die Abbildung 5 noch einmal die tetraplots für die neuen proben machen?
# Die Datenbank nennt sich SG_20180612_NZBxWCytokines. Nimm am besten die Probe 13_S2_NZBxW_1_4hP+I_001_CD44 dafür.
source("YH_bintriploT_functions.r")
...
pdf.filename = sprintf("%s_%s_%s_double%s_%s.pdf",
                       fcs$shortenFilename(fcs$file.list[fcs$file.idx]),fcs$feat.Z1,fcs$feat.Z2,maxfreq,color)
dev.copy(pdf,pdf.filename)
dev.off()
printf("Saved as %s",pdf.filename)
...
############# 20181005 for PRI-Manuscript Fig 7 E NEW
### heatmap double producers
# 601_old1_4hP+I_004_CD44_IL21_CD40L_double50_green.pdf
# 601_old2_4hP+I_001_CD44_IL21_CD40L_double50_green.pdf
### load library
library(RSQLite)
rm(list = ls())
fcs = new.env()
...
fcs$db.path=file.path("","data","databases")
fcs$db.name="SG_20180601_NZBxW-IL21Kinetik.sqlite3"
############################################################
### CONNECT TO DATABASE
fcs$conn = dbConnect(SQLite(), dbname = file.path(fcs$db.path,fcs$db.name))
...
############# 20181106 for PRI-Manuscript Fig 7 E ADD
### heatmap double producers
# 601_old1_4hP+I_004_CD44_IL21_CD40L_double50_green.pdf
### load library
rm(list = ls())
...
############################################################
############## 20200129 PRI manuscript Fig 6 E ( Figure 7 is now Figure 6!)
# NOTE: THIS IS NOT DOUBLE POSITIVE, BUT FOR PD1+ IFNG+ IL21+ AND CXCR5-
# 20200129_627_4hP+I_011_CD44_IL21_CXCR5_double80_green.pdf
rm(list = ls())
fcs = new.env()
source("YH_bintriploT_functions.r")
