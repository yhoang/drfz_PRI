  ...
  if (my.LENGTHS) {
    ...
    if ((!bg | density) & !png & this$plot.percentage) {
      if (cutoffs[1] > 0 & cutoffs[2] > 0 & cutoffs[3] > 0 & !density) {
        ...
        text(par()$usr[2] + 0.01 * (par()$usr[2] - par()$usr[1]) - 3.5, par()$usr[3] + 0.03 * (par()$usr[4] - par()$usr[3]), label=paste0("z-m: ",round(mean(this$tri.q2.feature_z),2)), col="blue", cex=1.00 * set.cex, pos=2, xpd=TRUE)
        ...
        text(par()$usr[2] + 0.01 * (par()$usr[2] - par()$usr[1]) - 3.5, par()$usr[4] - 0.04 * (par()$usr[4] - par()$usr[3]), label=paste0("z-m: ",round(mean(this$tri.q3.feature_z),2)), col="blue", cex=1.00 * set.cex, pos=2, xpd=TRUE)
